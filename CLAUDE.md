...
This project is indexed by GitNexus as **furqan** (2735 symbols, 6287 relationships, 206 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
