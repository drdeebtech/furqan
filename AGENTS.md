...
This project is indexed by GitNexus as **furqan** (2667 symbols, 6128 relationships, 200 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
