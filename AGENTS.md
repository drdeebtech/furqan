...
This project is indexed by GitNexus as **furqan** (8933 symbols, 17820 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
