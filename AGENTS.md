...
This project is indexed by GitNexus as **furqan** (7736 symbols, 13095 relationships, 294 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
