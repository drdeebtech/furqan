...
- **Free assessment abuse**: if the assessment is configured free, a student must not be able to farm unlimited free specialist sessions — assessments are constrained (e.g. limited per student) per the configured policy. *(Exact limit is a clarification below.)*
