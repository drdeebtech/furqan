      ...
      <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            ...
            className="flex h-8 w-8 items-center justify-center rounded-full border border-green-500/30 bg-green-500/10 text-green-400 transition-colors hover:bg-green-500/20"
            title="WhatsApp"
          >
