...
export const TRIAL_POLICY: { short: PolicyCopy; long: PolicyCopy } = {
  short: {
...
export const ABSENCE_POLICY: { short: PolicyCopy; long: PolicyCopy } = {
  short: {
...
export const PAY_CADENCE: PolicyCopy = {
...
export const PRICING_MODEL: { disambiguator: PolicyCopy; teacherRateCaption: PolicyCopy } = {
  disambiguator: {
