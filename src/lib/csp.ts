...
export function buildContentSecurityPolicy(nonce: string): string {
  ...
  return [
    "default-src 'self'",
    `script-src 'self' 'nonce-${nonce}' https://*.supabase.co https://*.daily.co https://js.stripe.com https://checkout.stripe.com https://vercel.live${scriptEval}`,
    ...
    "connect-src 'self' https://*.supabase.co https://*.daily.co wss://*.daily.co https://n8n.drdeeb.tech https://api.stripe.com https://*.ingest.sentry.io https://video.bunnycdn.com https://*.b-cdn.net https://vercel.live wss://ws-us3.pusher.com",
