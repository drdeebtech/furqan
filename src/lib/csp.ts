...
export function buildContentSecurityPolicy(nonce: string): string {
  ...
  return [
    ...
    "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://*.daily.co wss://*.daily.co https://n8n.drdeeb.tech https://api.stripe.com https://*.ingest.sentry.io https://video.bunnycdn.com https://*.b-cdn.net https://vercel.live wss://ws-us3.pusher.com https://us.i.posthog.com https://us-assets.i.posthog.com https://api-js.mixpanel.com",
