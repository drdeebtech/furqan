 ...
 * Matches the new grid layout: topbar space → welcome → 4 stat cards
 * → chart+widgets row → data table → recent sessions → evaluations.
 * Keep heights and spacing aligned with dashboard-content.tsx so the
 * loading-to-content transition feels seamless.
 */
export default function StudentDashboardLoading() {
  return (
    <div dir="rtl" className="space-y-6">
      ...
      {/* Row 2: Chart (3fr) + Right widgets (2fr) */}
