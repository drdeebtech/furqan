...
export default async function StudentProgressPage() {
  ...
  const [
    ...
    supabase.from("session_evaluations")
      .select("id, evaluation_type, hifz_score, tajweed_score, fluency_score, attendance_score, overall_score, strengths, areas_for_improvement, next_goals, teacher_comments, created_at")
      .eq("student_id", user.id)
      .order("created_at", { ascending: false })
      .limit(10)
