    ...
    return (
      ...
      >
        ...
        <Link
          ...
          className="glass glass-pill mt-6 block py-2.5 text-center text-sm font-medium text-gold transition-colors hover:bg-gold hover:text-background"
        >
  ...
  if (variant === "compact") {
    return (
      ...
      >
        ...
        <Link
          href={`/contact?teacher=${encodeURIComponent(teacher.name)}`}
          className="glass glass-pill mt-3 block py-1.5 text-center text-xs font-medium text-gold transition-colors hover:bg-gold hover:text-background"
        >
          {t("احجز", "Book")}
        </Link>
      </article>
