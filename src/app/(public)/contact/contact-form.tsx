...
/**
 * Renders a bilingual (Arabic/English) contact form and, after the form is submitted, displays a thank-you confirmation panel.
 *
 * The form includes fields for full name, email, WhatsApp number, country, student age, interested package, and an optional message. Submission prevents default navigation and switches the UI to the confirmation view.
 *
 * @returns A React element containing the contact form UI or a thank-you confirmation panel after submission.
 */
