      ...
      <section className="islamic-pattern relative overflow-hidden pt-24 pb-16 text-center">
        ...
        <div className="relative mx-auto max-w-3xl px-6">
          <nav aria-label={t("مسار الصفحة", "Breadcrumb")} className="text-xs text-muted-light">
            ...
            <span className="text-muted">{t("اتصل بنا", "Contact")}</span>
          </nav>
          ...
          <p className="mx-auto mt-3 max-w-xl text-sm leading-relaxed text-muted sm:text-base">
            {t(
              "نرد على رسائلك خلال 24 ساعة. واتساب، بريد، أو نموذج — اختر ما يناسبك.",
              "We answer within 24 hours. WhatsApp, email, or the form below — whichever suits you.",
            )}
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl gap-12 px-6 md:flex">
          <div className="mb-12 md:mb-0 md:w-2/5">
            ...
            <a
              ...
              className="mt-8 flex items-center justify-center gap-2 rounded-xl bg-success py-4 font-medium text-white transition-colors hover:bg-success/90 focus-ring"
            >
