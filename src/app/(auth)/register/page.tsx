...
export default function RegisterPage() {
  ...
  return (
    <>
      ...
      <p className="mb-6 text-sm text-muted">Create a student account</p>

      <div className="mb-4 rounded-lg border border-gold/20 bg-gold/5 p-3 text-xs text-gold-muted">
        التسجيل للطلاب فقط — المعلمون يُضافون بواسطة الإدارة
        <br />
        <span className="text-muted">
          Student registration only — teachers are added by admin
        </span>
      </div>
